...
List<Plan> planes = [
  ...
  Plan(
    ...
    descripcionLarga:
      ...
      cualidades: ["Subida de 10 videos", 
      "Duración máxima de 2 minutos por video", 
      "Calidad recomendada de 1080 Full HD", 
      "Posibilidad de subir un nuevo video al cubrir el cupo eliminando uno previo",
  ...
  Plan(
    ...
    descripcionLarga:
      ...
      cualidades:["Suscripción de 12 meses",
                ...
                Padding(
                  ...
                  child: CustomTextButton(
                    onTap: () {
                      ...
                      final planActual = playerProvider.getActualPlan();
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => PlanDetailsScreen(
                              goldPlan: planActual.nombre,
                              price: planActual.precio,
                              planItems: planActual.cualidades,
                            ),
                          ),
                        );
                      }
